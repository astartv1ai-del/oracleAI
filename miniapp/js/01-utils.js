...
const I18N = {
  ru: {
    ...
    authBotTitle: 'Осталось познакомиться с ботом', authBotCopy: 'Ты уже в Telegram — просто открой бота и нажми /start, а затем вернись сюда.', authOpenBot: 'Открыть бота',
    ageKicker: 'Твоё безопасное пространство', ageTitle: 'Сначала — бережная граница',
    ageCopy: 'OracleAI создан для пользователей от 16 лет. Здесь есть развлекательные астрологические практики и поддерживающие диалоги, но не медицинская, юридическая или психологическая помощь.',
    ageYearLabel: 'Год рождения', ageYearPlaceholder: 'например, 1999',
    ageYearInvalid: 'Напиши год рождения четырьмя цифрами, например 1999.',
    ageAccept: 'Мне есть 16 лет · продолжить', ageLeave: 'Мне нет 16 · закрыть',
    ageNote: 'Продолжая, ты подтверждаешь возраст и принимаешь бережный формат сервиса. Настройки памяти всегда доступны в разделе «Моё».',
    ageThanks: 'Спасибо за честность', ageComeBack: 'Вернись, когда тебе исполнится 16',
    ageComeBackCopy: 'Береги себя. Если тебе тревожно или нужна срочная поддержка, пожалуйста, обратись к близкому взрослому или в местную службу помощи.',
    ageErrorRetry: 'Не удалось сохранить подтверждение. Проверь соединение и попробуй снова.',
    intro1Title: 'Твоё небо уже ждёт', intro1Sub: 'Личный Оракул читает твою карту, Луну и расклады — честно, по звёздам.',
    intro2Title: 'Карты отвечают на твой вопрос', intro2Sub: 'Настоящая колода Райдера-Уэйта придёт прямо в чат. Задай вопрос — карты лягут в расклад.',
    intro3Title: 'Прогноз каждый день', intro3Sub: 'Натальная карта, лунный календарь и карта дня — утро начинается с опоры.',
    introChartTitle: 'Собери натальную карту', introChartCta: 'Собрать мою натальную карту ✨',
    introChartCopyName: 'Лилит посмотрит на твою карту, {name}.', introChartCopy: 'Твоя карта рождения откроет характер и путь.',
    introChartCopyTail: 'Планеты, дома и предназначение — по дате и времени рождения.',
    introStart: 'Начать ✨', introNext: 'Дальше →', introSkip: 'Пропустить',
  },
  en: {
    ...
    authBotTitle: 'One step left — meet the bot', authBotCopy: 'You are already in Telegram — just open the bot, tap /start, and come back here.', authOpenBot: 'Open the bot',
    ageKicker: 'Your safe space', ageTitle: 'First — a gentle boundary',
    ageCopy: 'OracleAI is designed for people aged 16 and over. It offers entertainment astrology practices and supportive conversations — not medical, legal or psychological help.',
    ageYearLabel: 'Birth year', ageYearPlaceholder: 'e.g. 1999',
    ageYearInvalid: 'Enter your birth year as four digits, e.g. 1999.',
    ageAccept: 'I am 16 or older · continue', ageLeave: 'I am under 16 · close',
    ageNote: 'By continuing you confirm your age and accept the gentle format of the service. Memory settings are always available under "Mine".',
    ageThanks: 'Thank you for being honest', ageComeBack: 'Come back when you turn 16',
    ageComeBackCopy: 'Take care of yourself. If you feel anxious or need urgent support, please reach out to a trusted adult or a local helpline.',
    ageErrorRetry: 'Could not save the confirmation. Check your connection and try again.',
    intro1Title: 'Your sky is already waiting', intro1Sub: 'Your personal Oracle reads your chart, the Moon and the spreads — honestly, by the stars.',
    intro2Title: 'The cards answer your question', intro2Sub: 'A real Rider–Waite deck comes straight into the chat. Ask a question — the cards will fall into a spread.',
    intro3Title: 'A forecast every day', intro3Sub: 'Natal chart, moon calendar and card of the day — mornings begin with solid ground.',
    introChartTitle: 'Build your natal chart', introChartCta: 'Build my natal chart ✨',
    introChartCopyName: 'Lilith will look at your chart, {name}.', introChartCopy: 'Your birth chart reveals character and path.',
    introChartCopyTail: 'Planets, houses and purpose — from your date and time of birth.',
    introStart: 'Begin ✨', introNext: 'Next →', introSkip: 'Skip',
  },
};
