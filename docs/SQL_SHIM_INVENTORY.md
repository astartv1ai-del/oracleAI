# SQL Shim Inventory — DB-001 Migration Checklist (CLOSED)

Status: **closed 2026-08-30.** All SQL call sites speak native PostgreSQL
dialect; the `_translate_sql` shim was removed (see
`docs/ADR/ADR-0003-shim-removal.md`, close-out section). Kept as historical
checklist.
