...
|---|---|---|---|---|
| P2-001 | UX / design | Seeded visual QA now covers age gate, home, chat, profile, chart, history, memory and Tarot at three mobile widths plus reduced-motion reference; pixel reconstruction adds measured geometry and admin responsive states. | Capture visual regression matrix for landing, home, chat, profile, chart, tarot, memory, loading, empty, error and reduced-motion states; fix inconsistencies. | Done locally for covered states; desktop/loading/error/manual visual review open |
