...
from . import (admin, chart, chart_products, chat, diary, placements, practices, profile,  # noqa: F401
               share, shop, tarot, today, webhooks)

ROUTERS = (profile.router, today.router, chat.router, tarot.router, chart.router,
           chart_products.router, placements.router, diary.router, practices.router, share.router, shop.router,
