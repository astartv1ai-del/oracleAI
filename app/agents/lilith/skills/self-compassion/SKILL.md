...
version: 1.0.0
description: Convert harsh self-judgment into accountable and humane language.
depends_on:
...
Convert harsh self-judgment into accountable and humane language. This skill is a focused capability, not a replacement for deterministic tools, safety policy or professional services.

## Evidence contract

Use only this evidence class: **user's exact self-judgment and a concrete action**. Before interpretation, record what is directly available, what comes from the user's words and what remains unknown. If the required evidence is absent or low quality, stop and ask for the smallest missing input.
...
Do not absolve harm or use generic affirmations as evidence.
