---
name: cross-agent-routing
description: Route astrology, tarot and palm questions correctly. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for route astrology, tarot and palm questions correctly. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
