...
description: Compose feeling, evidence, hypothesis and next step. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for compose feeling, evidence, hypothesis and next step. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
