---
name: practice-follow-through
description: Support practice continuity without pressure. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for support practice continuity without pressure. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
