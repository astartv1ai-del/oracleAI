...
description: Connect matrix themes to a relationship question. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for connect Matrix themes to a relationship question. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
