...
description: Turn vague requests into one clear reflective question. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for turn vague requests into one clear reflective question. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
