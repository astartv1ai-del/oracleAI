---
name: placement-translation
description: Translate a placement into plain language. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for translate a placement into plain language. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
