...
description: Save only explicit durable facts, goals or dates. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for save only explicit durable facts, goals or dates. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
