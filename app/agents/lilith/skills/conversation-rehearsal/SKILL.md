...
version: 1.0.0
description: Rehearse a difficult conversation using observation, request and boundary.
depends_on:
  - anti-barnum-protocol
requires_tools: recall_memory recall_diary
tags: ['communication', 'rehearsal']
license: Proprietary
...
Rehearse a difficult conversation using observation, request and boundary. This skill is a focused capability, not a replacement for deterministic tools, safety policy or professional services.

## Evidence contract

Use only this evidence class: **specific conversation goal and facts**. Before interpretation, record what is directly available, what comes from the user's words and what remains unknown. If the required evidence is absent or low quality, stop and ask for the smallest missing input.
...
Do not script manipulation, threats or certainty about response.
