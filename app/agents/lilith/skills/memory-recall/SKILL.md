---
name: memory-recall
description: Use relevant opt-in memory and avoid unrelated facts. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for use relevant opt-in memory and avoid unrelated facts. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
