---
name: daily-ritual
description: Compose a short safe daily ritual. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for compose a short safe daily ritual. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
