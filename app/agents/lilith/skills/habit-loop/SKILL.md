...
name: habit-loop
version: 1.0.0
description: Map cue, routine, reward and friction for one behavior change.
depends_on:
...
Map cue, routine, reward and friction for one behavior change. This skill is a focused capability, not a replacement for deterministic tools, safety policy or professional services.

## Evidence contract

Use only this evidence class: **one repeated behavior and its context**. Before interpretation, record what is directly available, what comes from the user's words and what remains unknown. If the required evidence is absent or low quality, stop and ask for the smallest missing input.
...
Do not claim willpower failure or prescribe treatment.
