...
description: Reflect on work conditions without financial guarantees. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for reflect on work conditions without financial guarantees. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
