---
name: matrix-lines
description: Read symbolic love, money and purpose lines without fate claims. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for read symbolic love, money and purpose lines without fate claims. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
