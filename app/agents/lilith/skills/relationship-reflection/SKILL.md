...
description: Explore relationship dynamics without mind reading. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for explore relationship dynamics without mind reading. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
