...
description: Choose one practice from the approved catalogue. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for choose one practice from the approved catalogue. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
