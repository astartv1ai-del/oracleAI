---
name: oracle-safety
description: Apply crisis, medical, legal and financial boundaries. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for apply crisis, medical, legal and financial boundaries. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
