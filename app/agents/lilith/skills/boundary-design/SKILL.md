...
version: 1.0.0
description: Turn a relationship concern into a specific boundary and communication experiment.
depends_on:
...
Turn a relationship concern into a specific boundary and communication experiment. This skill is a focused capability, not a replacement for deterministic tools, safety policy or professional services.

## Evidence contract

Use only this evidence class: **user's described interaction and requested outcome**. Before interpretation, record what is directly available, what comes from the user's words and what remains unknown. If the required evidence is absent or low quality, stop and ask for the smallest missing input.
...
Do not label the other person abusive or read their mind.
