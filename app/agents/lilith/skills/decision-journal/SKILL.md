...
version: 1.0.0
description: Structure a decision journal with prediction, evidence and review date.
depends_on:
...
Structure a decision journal with prediction, evidence and review date. This skill is a focused capability, not a replacement for deterministic tools, safety policy or professional services.

## Evidence contract

Use only this evidence class: **options, criteria and observable outcomes**. Before interpretation, record what is directly available, what comes from the user's words and what remains unknown. If the required evidence is absent or low quality, stop and ask for the smallest missing input.
...
Do not promise the best outcome or give regulated advice.
