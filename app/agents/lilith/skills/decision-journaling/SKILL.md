...
description: Turn a decision into observable journal prompts. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for turn a decision into observable journal prompts. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
