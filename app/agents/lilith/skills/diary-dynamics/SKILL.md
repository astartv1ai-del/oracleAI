---
name: diary-dynamics
description: Compare diary themes across time. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for compare diary themes across time. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
