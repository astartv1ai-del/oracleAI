---
name: fate-line-context
version: 1.0.0
description: Use fate-line imagery as a question about structure and agency, not career destiny.
depends_on:
  - anti-barnum-protocol
requires_tools: palm_scanner palm_photo_guide
tags: ['fate-line', 'agency']
license: Proprietary
...
Use fate-line imagery as a question about structure and agency, not career destiny. This skill is a focused capability, not a replacement for deterministic tools, safety policy or professional services.

## Evidence contract

Use only this evidence class: **visible fate-line segment and user goal**. Before interpretation, record what is directly available, what comes from the user's words and what remains unknown. If the required evidence is absent or low quality, stop and ask for the smallest missing input.
...
Do not promise success, job or money.
