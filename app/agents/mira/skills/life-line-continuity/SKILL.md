---
name: life-line-continuity
version: 1.0.0
description: Describe life-line shape while explicitly separating it from longevity or health.
depends_on:
  - anti-barnum-protocol
requires_tools: palm_scanner palm_photo_guide
tags: ['life-line', 'safety']
license: Proprietary
...
# life-line-continuity

## Purpose

Describe life-line shape while explicitly separating it from longevity or health. This skill is a focused capability, not a replacement for deterministic tools, safety policy or professional services.

## Evidence contract

Use only this evidence class: **clear life-line image**. Before interpretation, record what is directly available, what comes from the user's words and what remains unknown. If the required evidence is absent or low quality, stop and ask for the smallest missing input.
...
Never estimate age, death, illness or lifespan.
