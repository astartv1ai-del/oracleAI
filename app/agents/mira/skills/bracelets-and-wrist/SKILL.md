---
name: bracelets-and-wrist
description: Describe visible wrist bracelets as tradition. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for describe visible wrist bracelets as tradition. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
