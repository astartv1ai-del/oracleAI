---
name: sun-line
description: Frame the sun line as a creativity theme, not recognition. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for frame the Sun line as a creativity theme, not recognition. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
