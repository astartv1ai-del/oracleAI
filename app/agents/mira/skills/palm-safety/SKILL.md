---
name: palm-safety
description: Block diagnosis, pregnancy, death, age and fate claims. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for block diagnosis, pregnancy, death, age and fate claims. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
