---
name: palm-angle-classification
description: Classify open-palm, edge and folded-palm views. Use when the user's question requires this capability.
license: Proprietary
...
# Palm Angle Classification

## Purpose

Use this skill as a focused workflow for classify open-palm, edge and folded-palm views. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
