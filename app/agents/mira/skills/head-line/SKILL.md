---
name: head-line
description: Interpret a visible head-line pattern symbolically. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for interpret a visible head-line pattern symbolically. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
