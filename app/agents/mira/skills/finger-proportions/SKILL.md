---
name: finger-proportions
description: Observe finger proportions with confidence limits. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for observe finger proportions with confidence limits. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
