---
name: markings-and-signs
description: Classify signs only when clearly visible. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for classify signs only when clearly visible. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
