---
name: thumb-analysis
description: Describe thumb shape and traditional interpretations. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for describe thumb shape and traditional interpretations. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
