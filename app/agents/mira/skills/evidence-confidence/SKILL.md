...
description: Separate observation, interpretation and unknown. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for separate observation, interpretation and unknown. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
