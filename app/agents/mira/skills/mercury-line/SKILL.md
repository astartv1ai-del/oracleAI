---
name: mercury-line
description: Handle the mercury zone without medical inference. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for handle the Mercury zone without medical inference. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
