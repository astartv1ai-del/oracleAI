---
name: travel-lines
description: Avoid exact travel events and dates. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for avoid exact travel events and dates. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
