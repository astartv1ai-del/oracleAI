---
name: mounts
description: Describe visible mounts as a traditional traditional vocabulary. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for describe visible mounts as a traditional traditional vocabulary. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
