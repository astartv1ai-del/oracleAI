...
version: 1.0.0
description: Compare two palm images with a confounder checklist before claiming visual change.
depends_on:
  - anti-barnum-protocol
requires_tools: palm_scanner palm_photo_guide
tags: ['comparison', 'image']
license: Proprietary
...
Compare two palm images with a confounder checklist before claiming visual change. This skill is a focused capability, not a replacement for deterministic tools, safety policy or professional services.

## Evidence contract

Use only this evidence class: **dated images with comparable pose and light**. Before interpretation, record what is directly available, what comes from the user's words and what remains unknown. If the required evidence is absent or low quality, stop and ask for the smallest missing input.
...
Do not claim fate or character changed from a photo difference.
