---
name: mounts-topography
version: 1.0.0
description: Map visible palm regions and distinguish contour from traditional association.
depends_on:
  - anti-barnum-protocol
requires_tools: palm_scanner palm_photo_guide
tags: ['mounts', 'topography']
license: Proprietary
...
Map visible palm regions and distinguish contour from traditional association. This skill is a focused capability, not a replacement for deterministic tools, safety policy or professional services.

## Evidence contract

Use only this evidence class: **well-lit palm and anatomical zone**. Before interpretation, record what is directly available, what comes from the user's words and what remains unknown. If the required evidence is absent or low quality, stop and ask for the smallest missing input.
...
Do not use mounts for disease, wealth or lifespan.
