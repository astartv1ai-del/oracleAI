...
description: Explore dynamics without reading a third party's mind. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for explore dynamics without reading a third party's mind. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
