...
name: reading-review
version: 1.0.0
description: Review a past reading for evidence, misses, alternative explanations and learning.
depends_on:
...
Review a past reading for evidence, misses, alternative explanations and learning. This skill is a focused capability, not a replacement for deterministic tools, safety policy or professional services.

## Evidence contract

Use only this evidence class: **dated reading and actual observations**. Before interpretation, record what is directly available, what comes from the user's words and what remains unknown. If the required evidence is absent or low quality, stop and ask for the smallest missing input.
...
Do not count vague matches as successful prediction.
