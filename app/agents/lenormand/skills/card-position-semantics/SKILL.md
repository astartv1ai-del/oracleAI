---
name: card-position-semantics
description: Adapt a card meaning to its spread position. Use when the user's question requires this capability.
license: Proprietary
...
# Card Position Semantics

## Purpose

Use this skill as a focused workflow for adapt a card meaning to its spread position. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
