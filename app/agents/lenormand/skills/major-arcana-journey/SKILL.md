...
description: Read the major arcana as an archetypal sequence. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for read the Major Arcana as an archetypal sequence. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
