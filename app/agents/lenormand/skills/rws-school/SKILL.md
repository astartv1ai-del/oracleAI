---
name: rws-school
description: Apply rider-waite-smith-specific visual conventions. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for apply Rider-Waite-Smith-specific visual conventions. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
