...
description: Route astrology, matrix and palm questions. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for route astrology, Matrix and palm questions. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
