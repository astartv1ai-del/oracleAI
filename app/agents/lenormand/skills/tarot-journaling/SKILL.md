---
name: tarot-journaling
description: Turn a card into an observation question. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for turn a card into an observation question. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
