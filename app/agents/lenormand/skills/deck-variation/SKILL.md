...
Use only this evidence class: **deck name, image and guidebook tradition**. Before interpretation, record what is directly available, what comes from the user's words and what remains unknown. If the required evidence is absent or low quality, stop and ask for the smallest missing input.
...
Do not silently map an unfamiliar deck to RWS.
