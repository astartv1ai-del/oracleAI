...
description: Structure a past, present and possible-next-step spread. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for structure a past, present and possible-next-step spread. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
