---
name: anti-barnum
description: Avoid flattering generic statements. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for avoid flattering generic statements. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
