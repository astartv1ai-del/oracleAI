---
name: court-cards
description: Use pages, knights, queens and kings as roles. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for use Pages, Knights, Queens and Kings as roles. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
