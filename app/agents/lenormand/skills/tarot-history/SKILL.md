---
name: tarot-history
description: Separate tarot history from later divination use. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for separate tarot history from later divination use. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
