...
name: major-arcana
version: 1.0.0
description: Read Major Arcana as archetypal sequence and position-specific symbolism.
depends_on:
  - anti-barnum-protocol
requires_tools: draw_tarot
tags: ['major-arcana', 'rws']
license: Proprietary
...
Read Major Arcana as archetypal sequence and position-specific symbolism. This skill is a focused capability, not a replacement for deterministic tools, safety policy or professional services.

## Evidence contract

Use only this evidence class: **card identity, image and spread position**. Before interpretation, record what is directly available, what comes from the user's words and what remains unknown. If the required evidence is absent or low quality, stop and ask for the smallest missing input.
...
Never literalize Death, Tower, Devil or Judgement.
