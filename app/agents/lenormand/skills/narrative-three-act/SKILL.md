---
name: narrative-three-act
version: 1.0.0
description: Build a beginning, tension and next-step narrative from spread positions.
depends_on:
  - anti-barnum-protocol
requires_tools: draw_tarot
tags: ['narrative', 'spread']
license: Proprietary
...
Build a beginning, tension and next-step narrative from spread positions. This skill is a focused capability, not a replacement for deterministic tools, safety policy or professional services.

## Evidence contract

Use only this evidence class: **position labels and card evidence**. Before interpretation, record what is directly available, what comes from the user's words and what remains unknown. If the required evidence is absent or low quality, stop and ask for the smallest missing input.
...
Do not smooth contradictions into a guaranteed ending.
