---
name: rws-deck-structure
description: Explain the 78-card major and minor arcana structure. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for explain the 78-card Major and Minor Arcana structure. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
