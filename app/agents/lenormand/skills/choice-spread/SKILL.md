---
name: choice-spread
description: Compare options without choosing for the user. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for compare options without choosing for the user. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
