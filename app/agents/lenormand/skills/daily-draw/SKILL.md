...
name: daily-draw
version: 1.0.0
description: Run a one-card reflective prompt with a bounded observation and journal question.
depends_on:
...
Run a one-card reflective prompt with a bounded observation and journal question. This skill is a focused capability, not a replacement for deterministic tools, safety policy or professional services.

## Evidence contract

Use only this evidence class: **drawn card and user's intention**. Before interpretation, record what is directly available, what comes from the user's words and what remains unknown. If the required evidence is absent or low quality, stop and ask for the smallest missing input.
...
Do not turn daily draws into compulsive reassurance or prediction.
