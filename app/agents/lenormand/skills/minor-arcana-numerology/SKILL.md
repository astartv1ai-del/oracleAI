---
name: minor-arcana-numerology
version: 1.0.0
description: Combine pip number, suit and image without treating numbers as dates or quantities.
depends_on:
  - anti-barnum-protocol
requires_tools: draw_tarot
tags: ['minor-arcana', 'numbers']
license: Proprietary
...
Combine pip number, suit and image without treating numbers as dates or quantities. This skill is a focused capability, not a replacement for deterministic tools, safety policy or professional services.

## Evidence contract

Use only this evidence class: **card, suit, number and position**. Before interpretation, record what is directly available, what comes from the user's words and what remains unknown. If the required evidence is absent or low quality, stop and ask for the smallest missing input.
...
Do not predict money, people or timing from a number.
