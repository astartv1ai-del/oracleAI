---
name: career-spread
description: Reflect on work questions without money guarantees. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for reflect on work questions without money guarantees. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
