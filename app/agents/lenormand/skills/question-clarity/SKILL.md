...
description: Ask for a concrete question when needed. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for ask for a concrete question when needed. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
