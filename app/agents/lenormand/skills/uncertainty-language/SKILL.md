...
description: Use probability, agency and testable reflection. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for use probability, agency and testable reflection. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
