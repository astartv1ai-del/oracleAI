---
name: minor-arcana-suits
description: Interpret suits, elements and numerical development. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for interpret suits, elements and numerical development. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
