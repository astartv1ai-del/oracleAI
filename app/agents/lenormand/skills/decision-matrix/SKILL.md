...
version: 1.0.0
description: Use cards as reflection prompts alongside explicit user criteria for a choice.
depends_on:
...
Use cards as reflection prompts alongside explicit user criteria for a choice. This skill is a focused capability, not a replacement for deterministic tools, safety policy or professional services.

## Evidence contract

Use only this evidence class: **options, criteria and card positions**. Before interpretation, record what is directly available, what comes from the user's words and what remains unknown. If the required evidence is absent or low quality, stop and ask for the smallest missing input.
...
Do not decide for the user or replace due diligence.
