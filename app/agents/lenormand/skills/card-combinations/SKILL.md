...
description: Combine cards into a coherent story. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for combine cards into a coherent story. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
