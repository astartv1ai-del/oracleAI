...
description: Interpret planets in signs as traditional tendencies. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for interpret planets in signs as traditional tendencies. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
