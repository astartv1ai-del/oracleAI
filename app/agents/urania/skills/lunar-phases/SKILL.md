...
name: lunar-phases
version: 1.0.0
description: Use lunar phase symbolism as a time-bounded reflective planning lens.
depends_on:
...
Use lunar phase symbolism as a time-bounded reflective planning lens. This skill is a focused capability, not a replacement for deterministic tools, safety policy or professional services.

## Evidence contract

Use only this evidence class: **calculated phase and user goal**. Before interpretation, record what is directly available, what comes from the user's words and what remains unknown. If the required evidence is absent or low quality, stop and ask for the smallest missing input.
...
Do not forecast guaranteed mood, fertility or event timing.
