...
name: retrogrades
version: 1.0.0
description: Frame retrograde symbolism as a traditional review metaphor, not a causal effect.
depends_on:
  - anti-barnum-protocol
requires_tools: get_chart get_all_placements
tags: ['retrograde', 'reflection']
license: Proprietary
...
Frame retrograde symbolism as a traditional review metaphor, not a causal effect. This skill is a focused capability, not a replacement for deterministic tools, safety policy or professional services.

## Evidence contract

Use only this evidence class: **planet and retrograde flag from calculation**. Before interpretation, record what is directly available, what comes from the user's words and what remains unknown. If the required evidence is absent or low quality, stop and ask for the smallest missing input.
...
Do not blame retrograde periods for real-world harm.
