---
name: moon-cycles
description: Use lunar cycles as reflective timing, not guarantees. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for use lunar cycles as reflective timing, not guarantees. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
