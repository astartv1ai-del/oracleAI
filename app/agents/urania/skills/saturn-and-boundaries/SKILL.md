---
name: saturn-and-boundaries
description: Frame limits and discipline without fear. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for frame limits and discipline without fear. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
