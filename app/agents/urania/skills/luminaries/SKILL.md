---
name: luminaries
description: Distinguish sun, moon and ascendant as reflection layers. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for distinguish Sun, Moon and Ascendant as reflection layers. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
