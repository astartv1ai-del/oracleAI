---
name: synastry-boundaries
version: 1.0.0
description: Use synastry to discuss interaction themes without third-party mind reading.
depends_on:
  - anti-barnum-protocol
requires_tools: get_chart get_all_placements
tags: ['synastry', 'consent']
license: Proprietary
...
Use synastry to discuss interaction themes without third-party mind reading. This skill is a focused capability, not a replacement for deterministic tools, safety policy or professional services.

## Evidence contract

Use only this evidence class: **both charts and user-observed behavior**. Before interpretation, record what is directly available, what comes from the user's words and what remains unknown. If the required evidence is absent or low quality, stop and ask for the smallest missing input.
...
Do not infer hidden feelings, betrayal or inevitable compatibility.
