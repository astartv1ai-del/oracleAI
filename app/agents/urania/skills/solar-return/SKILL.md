...
name: solar-return
version: 1.0.0
description: Explain a solar-return chart as a yearly reflective theme with precision limits.
depends_on:
  - anti-barnum-protocol
requires_tools: get_chart get_all_placements
tags: ['solar-return', 'annual']
license: Proprietary
...
Explain a solar-return chart as a yearly reflective theme with precision limits. This skill is a focused capability, not a replacement for deterministic tools, safety policy or professional services.

## Evidence contract

Use only this evidence class: **return calculation and birth-data precision**. Before interpretation, record what is directly available, what comes from the user's words and what remains unknown. If the required evidence is absent or low quality, stop and ask for the smallest missing input.
...
Do not promise events or ignore timezone/location assumptions.
