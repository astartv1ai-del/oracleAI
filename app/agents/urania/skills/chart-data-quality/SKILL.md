---
name: chart-data-quality
description: Check birth date, time, place and precision mode. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for check birth date, time, place and precision mode. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
