---
name: transits
description: Use current transits only from the calculation tool. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for use current transits only from the calculation tool. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
