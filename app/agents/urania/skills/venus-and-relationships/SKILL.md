---
name: venus-and-relationships
description: Interpret values and relational patterns carefully. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for interpret values and relational patterns carefully. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
