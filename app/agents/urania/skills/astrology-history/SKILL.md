...
description: Separate historical schools and modern mixtures. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for separate historical schools and modern mixtures. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
