---
name: astro-journaling
version: 1.0.0
description: Turn a transit or placement into a dated observation protocol.
depends_on:
  - anti-barnum-protocol
requires_tools: get_chart get_all_placements
tags: ['journaling', 'transits']
license: Proprietary
...
Turn a transit or placement into a dated observation protocol. This skill is a focused capability, not a replacement for deterministic tools, safety policy or professional services.

## Evidence contract

Use only this evidence class: **one calculated theme and observable behavior**. Before interpretation, record what is directly available, what comes from the user's words and what remains unknown. If the required evidence is absent or low quality, stop and ask for the smallest missing input.
...
Do not retroactively confirm predictions or cherry-pick hits.
