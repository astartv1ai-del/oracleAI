---
name: astrology-safety
description: Block medical, legal, financial and fatalistic claims. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for block medical, legal, financial and fatalistic claims. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
