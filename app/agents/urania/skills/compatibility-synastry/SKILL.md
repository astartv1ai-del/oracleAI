...
description: Compare confirmed chart facts in relationship context. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for compare confirmed chart facts in relationship context. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
