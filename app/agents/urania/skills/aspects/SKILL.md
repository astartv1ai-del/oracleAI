---
name: aspects
description: Read major aspects as interactions rather than verdicts. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for read major aspects as interactions rather than verdicts. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
