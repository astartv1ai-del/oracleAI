...
description: Interpret thinking, communication and action patterns. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for interpret thinking, communication and action patterns. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
