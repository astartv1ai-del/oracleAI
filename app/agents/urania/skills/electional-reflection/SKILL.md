...
version: 1.0.0
description: Compare candidate dates using user criteria while keeping astrology symbolic.
depends_on:
...
Compare candidate dates using user criteria while keeping astrology symbolic. This skill is a focused capability, not a replacement for deterministic tools, safety policy or professional services.
