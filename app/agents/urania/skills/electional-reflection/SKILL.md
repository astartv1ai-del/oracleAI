---
name: electional-reflection
version: 1.0.0
description: Compare candidate dates using user criteria while keeping astrology traditional.
depends_on:
...
# electional-reflection

## Purpose

Compare candidate dates using user criteria while keeping astrology traditional. This skill is a focused capability, not a replacement for deterministic tools, safety policy or professional services.

## Evidence contract

Use only this evidence class: **candidate dates, constraints and calculated data**. Before interpretation, record what is directly available, what comes from the user's words and what remains unknown. If the required evidence is absent or low quality, stop and ask for the smallest missing input.
...
Do not provide legal, medical, financial or guaranteed timing.
