---
name: natal-chart-foundations
description: Explain the structure and precision limits of a natal chart. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for explain the structure and precision limits of a natal chart. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
