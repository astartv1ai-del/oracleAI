---
name: dignities-traditions
version: 1.0.0
description: Compare dignity terminology across a named astrological school.
depends_on:
  - anti-barnum-protocol
requires_tools: get_chart get_all_placements
tags: ['tradition', 'technique']
license: Proprietary
...
# dignities-traditions

## Purpose

Compare dignity terminology across a named astrological school. This skill is a focused capability, not a replacement for deterministic tools, safety policy or professional services.

## Evidence contract

Use only this evidence class: **tradition name and calculated placement**. Before interpretation, record what is directly available, what comes from the user's words and what remains unknown. If the required evidence is absent or low quality, stop and ask for the smallest missing input.
...
Do not present one school's rule as universal or scientific.
