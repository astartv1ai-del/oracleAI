---
name: electional-framework
description: Discuss timing questions with explicit uncertainty. Use when the user's question requires this capability.
license: Proprietary
...
# Electional Framework

## Purpose

Use this skill as a focused workflow for discuss timing questions with explicit uncertainty. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
