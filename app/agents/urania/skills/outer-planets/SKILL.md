---
name: outer-planets
description: Explain slow traditional themes without personal determinism. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for explain slow traditional themes without personal determinism. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
