...
description: Use houses, ascendant and mc only with precise time. Use when the user's question requires this capability.
license: Proprietary
...
Use this skill as a focused workflow for use houses, Ascendant and MC only with precise time. It is not a replacement for a deterministic tool and it cannot grant the agent new permissions.
